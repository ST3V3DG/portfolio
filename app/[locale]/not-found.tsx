...
export default function NotFound() {
	...
	return (
		<>
			<main className="grid h-screen place-content-center px-6 text-center bg-grainy">
				...
				<Button
					asChild
					className="mt-4 bg-accent rounded-none hover:bg-accent/90 transition duration-200 w-fit mx-auto text-base"
					size="lg"
				>
