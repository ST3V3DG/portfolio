...
export default function Hero() {
  ...
  return (
    <section id="hero" className="bg-background-grainy">
      <div className="pt-16 max-w-7xl px-6 pb-6 mx-auto lg:min-h-screen @container flex flex-col justify-center gap-12">
        <h1 className="text-6xl @lg:text-[7rem] leading-none text-balance capitalize text-accent">
