...
export default function Projects() {
	...
	return (
		<section
			id="projects"
			className="bg-background-grainy focus-within:outline-none"
		>
			<div className="py-32 flex flex-col gap-12 bg-background-grainy relative z-1 max-w-7xl px-6 mx-auto focus-within:outline-none">
				...
				<div className="grid lg:grid-cols-4 gap-4 grow *:border *:overflow-hidden focus-within:outline-none">
					<div className="lg:col-span-2 lg:row-span-2">
						<Link
							aria-label="eden cosmetics"
							className="group relative lg:grayscale lg:hover:grayscale-0 transition duration-300"
							target="_blank"
						...
						>
							<Image
								...
								height={1500}
								src="/images/mac-eden-cosmetics.png"
								width={1500}
							/>
					...
					<div className="lg:col-span-2 lg:row-span-1">
						...
						>
							<Image
								...
								className="size-full object-cover group-hover:scale-110 transition duration-300"
								height={1500}
								src="/images/iphone-crypto-trade-alpha.png"
								width={1500}
							/>
							<div className="absolute inset-0  bg-linear-to-b from-transparent to-black lg:to-75% lg:opacity-0 lg:group-hover:opacity-50 transition duration-300 pointer-events-none"></div>
							<div className="absolute bottom-0 left-0 right-0 lg:opacity-0 lg:group-hover:opacity-100 text-accent transition duration-300 p-6 flex justify-between items-start">
								<h3 className="flex items-center gap-1">
									<span>Crypto Trade Alpha</span>
									<ExternalLink className="size-3 stroke-4" />
								</h3>
								<ul className="flex flex-col justify-between items-end font-clash-display">
									<li>Crypto</li>
					...
					<div className="lg:col-span-2 lg:row-span-1">
						<Link
							aria-label="fashion studio"
							className="group relative lg:grayscale lg:hover:grayscale-0 transition duration-300"
							target="_blank"
							href="https://fashionstudio.vercel.app/"
						>
							<Image
								alt="project image"
								className="size-full object-cover group-hover:scale-110 transition duration-300"
								height={1500}
								src="/images/mac-fashion-studio.png"
								width={1500}
							/>
							<div className="absolute inset-0 bg-linear-to-b from-transparent to-black lg:to-75% lg:opacity-0 lg:group-hover:opacity-50 transition duration-300 pointer-events-none"></div>
							<div className="absolute bottom-0 left-0 right-0 lg:opacity-0 lg:group-hover:opacity-100 text-accent transition duration-300 p-6 flex justify-between items-start">
					...
					<div className="lg:col-span-3 lg:row-span-1">
						...
						>
							<Image
								...
								className="size-full object-cover group-hover:scale-110 transition duration-300"
								height={1500}
								src="/images/mac-odysia.png"
								width={1500}
							/>
							<div className="absolute inset-0  bg-linear-to-b from-transparent to-black lg:to-75% lg:opacity-0 lg:group-hover:opacity-50 transition duration-300 pointer-events-none"></div>
							<div className="absolute bottom-0 left-0 right-0 lg:opacity-0 lg:group-hover:opacity-100 text-accent transition duration-300 p-6 flex justify-between items-start">
								<h3 className="flex items-center gap-1">
									<span>Odysia Hotel</span>
									<ExternalLink className="size-3 stroke-4" />
								</h3>
								<ul className="flex flex-col justify-between items-end font-clash-display">
									<li>Journey</li>
					...
					<div className="lg:col-span-1 lg:row-span-1">
						<Link
							aria-label="steve the developer v2"
							className="group relative lg:grayscale lg:hover:grayscale-0 transition duration-300"
							target="_blank"
							href="https://portfolio-steve-v2.vercel.app/"
						>
							<Image
								alt="project image"
								className="size-full object-cover group-hover:scale-110 transition duration-300"
								height={1500}
								src="/images/ipad-air-steve-the-developer.png"
								width={1500}
							/>
							<div className="absolute inset-0  bg-linear-to-b from-transparent to-black lg:to-75% lg:opacity-0 lg:group-hover:opacity-50 transition duration-300 pointer-events-none"></div>
							<div className="absolute bottom-0 left-0 right-0 lg:opacity-0 lg:group-hover:opacity-100 text-accent transition duration-300 p-6 flex justify-between items-start">
					...
					<div className="lg:col-span-2 lg:row-span-1">
						...
						>
							<Image
								...
								className="size-full object-cover group-hover:scale-110 transition duration-300"
								height={1500}
								src="/images/iphone-mck-medical-care.png"
								width={1500}
							/>
							<div className="absolute inset-0  bg-linear-to-b from-transparent to-black lg:to-75% lg:opacity-0 lg:group-hover:opacity-50 transition duration-300 pointer-events-none"></div>
							<div className="absolute bottom-0 left-0 right-0 lg:opacity-0 lg:group-hover:opacity-100 text-accent transition duration-300 p-6 flex justify-between items-start">
								<h3 className="flex items-center gap-1">
									<span>MCK Medical Care</span>
									<ExternalLink className="size-3 stroke-4" />
								</h3>
								<ul className="flex flex-col justify-between items-end font-clash-display">
									<li>Medical</li>
