...
export default function Projects() {
    ...
    {/*
        <svg width="319" height="792" viewBox="0 0 319 792" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M33.4762 0.309937C33.4762 0.309937 -26.8329 76.2484 15.6671 116.31C58.167 156.371 138.586 157.603 138.586 157.603C192.167 157.603 313.667 140.31 313.667 210.31C280.167 301.81 85.667 186.31 55.167 301.81C55.167 420.31 356.167 338.31 313.667 441.81C296.699 483.133 175.45 575.357 138.586 618.31C62.4045 707.074 55.167 791.31 55.167 791.31" stroke="black"/>
</svg>


        <svg width="348" height="729" viewBox="0 0 348 729" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M33.4762 0.309937C33.4762 0.309937 -26.8329 76.2484 15.6671 116.31C58.167 156.371 155.667 157.603 172.086 157.603C225.005 157.603 331.563 198.31 313.667 274.31C295.7 350.615 172.086 350.31 172.086 420.31C172.086 505.441 347.167 481.31 347.167 560.31C347.167 639.31 237.667 727.81 237.667 727.81" stroke="black"/>
</svg>
 */}
}