...
export default function HeroSection() {
	...
	return (
		<section className="relative lg:h-dvh">
			...
			<div className="mx-auto flex h-full max-w-6xl items-center justify-center px-6 pt-28 pb-60 lg:pt-0 lg:pb-0">
				<div className="grid min-w-full items-center gap-56 lg:grid-cols-7 lg:gap-0">
					<div className="flex w-full flex-col items-center text-center lg:col-span-5 lg:items-start lg:text-left">
						...
						<div className="mt-4 max-w-xl text-pretty text-gray-300">
							I help enhance your online presence by strengthening your visibility, credibility, and
							growth. My goal is to lay a solid foundation for a{" "}
						...
						<div className="mt-8 flex flex-col gap-4 md:mt-4 md:flex-row">
							<div>
								<AvatarGroup />
							</div>
						...
						<div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
							<Button
								asChild
								className="before:-z-10 group relative rounded-full bg-transparent px-0 text-base before:absolute before:top-0 before:left-0 before:h-full before:w-full before:rounded-full before:border-2 before:border-blue-700 hover:bg-transparent"
								size="lg"
							>
								<Link href="#">
							...
							<Button asChild className="rounded-full" key={2} size="lg" variant="ghost">
								<Link
									className="group relative z-50 px-5 text-base before:absolute before:bottom-0 before:z-50 before:h-0.5 before:w-[80%] before:rounded-full before:bg-white/5 before:transition-all before:duration-300 hover:before:size-full hover:before:ring hover:before:ring-white/5 dark:hover:bg-transparent"
									href="#projects"
								>
									<span>
										See projects{" "}
